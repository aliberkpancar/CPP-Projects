...
/*   Updated: 2024/08/27 10:16:25 by apancar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const ClapTrap &copy)
{
	if (this == &copy)
		return ;
	*this = copy;
	std::cout << "\033[1;33mCopy constructor is called...\033[0m" << std::endl;
}
...
ClapTrap& ClapTrap::operator=(const ClapTrap &oper)
{
	...
	std::cout << "\033[1;33mAssignation operator is called...\033[0m" << std::endl;
	return *this;
}
